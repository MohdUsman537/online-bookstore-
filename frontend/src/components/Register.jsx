    ...
    <div className="h-[calc(100vh-120px)] flex justify-center items-center">
      <div className="w-full max-w-sm mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-4">
            ...
            <input
              ...
              className="shadow apperance-none border rounded w-full py-2 px-3leading-tight focus:outline-none focus:shadow"
            />
          </div>
          <div className="mb-4">
            <label
        ...
        <p className="align-baseline font-medium mt-4 text-sm">
          ...
          <Link to="/register" className="text-blue-500 hover:text-blue">
            register
          </Link>
        </p>
        {/*google signin*/}
